import '../css/components/PrivacyPolicy.css';
const PrivacyPolicy = () => {
  return (
    <div className="PrivacyPolicy">
      <section>
        <h1 className="Green">Privacy policy</h1>
      ...
      <section>
        <h1 className="Green">Interpretation and Definitions</h1>
        <h2 className="Green">Interpretation</h2>
        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
        <h2 className="Green">Definitions</h2>
        <p>For the purposes of this Privacy Policy:</p>
        <ul>
          <li><b>Account</b> means a unique account created for You to access our Service or parts of our Service.</li>
          <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FootballTix B.V., Argostraat, Eindhoven 5631JZ.</li>
          ...
          <li><b>Country</b> refers to: Netherlands</li>
          ...
          <li><b>Website</b> refers to FootballTix, accessible from <a className="Green" href="http://footballtix.com">http://footballtix.com</a></li>
      ...
      <section>
        <h1 className="Green">Collecting and Using Your Personal Data</h1>
        <h2 className="Green">Types of Data Collected</h2>
        <h3 className="Green">Personal Data</h3>
        ...
        <h3 className="Green">Usage Data</h3>
        ...
        <h3 className="Green">Tracking Technologies and Cookies</h3>
      ...
      <section>
        <h1 className="Green">Children's Privacy</h1>
      ...
      <section>
        <h1 className="Green">Links to Other Websites</h1>
        <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
        <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
      </section>
      <section>
        <h1 className="Green">Changes to this Privacy Policy</h1>
