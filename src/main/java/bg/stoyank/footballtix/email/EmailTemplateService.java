...
public class EmailTemplateService {
    ...
    private String buildEmail(String title, String recipient, String[] body) {
        ...
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#444444\">" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>" +
                "  <table role=\"presentation\" width=\"100%\" style=\"border-collapse:collapse;min-width:100%;width:100%!important\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">" +
                "    <tbody><tr>" +
                "      <td width=\"100%\" height=\"53\" bgcolor=\"#444444\">" +
                "        <table role=\"presentation\" width=\"100%\" style=\"border-collapse:collapse;max-width:580px\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\">" +
                "          <tbody><tr>" +
                "            <td width=\"70\" bgcolor=\"#444444\" valign=\"middle\">" +
                ...
                "                  <tbody><tr>" +
                "                    <td bgcolor=\"#89df8f\" width=\"100%\" height=\"10\"></td>" +
                "                  </tr>" +
                "                </tbody></table>" +
                "      </td>" +
                ...
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#444444\">Hi " + recipient + ",</p>" +
                buildBody(body) +
                "      </td>" +
                "      <td width=\"10\" valign=\"middle\"><br></td>" +
                "    </tr>" +
