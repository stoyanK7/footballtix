...
public class FootballMatchService {
    ...
    public void updateFootballMatch(int footballMatchId, FootballMatch footballMatch) {
        ...
        for(Order order: orders) {
            ...
            emailService.send(email, subject, buildEmail(subject,email,footballMatch.getStartingDateTime()));
            if(!email.equals(accountEmail)) {
                emailService.send(accountEmail, subject, buildEmail(subject,accountEmail,footballMatch.getStartingDateTime()));
            }
        }
    }
    ...
    private String buildEmail(String subject, String to, Date newTime ) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + to + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">  </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> The starting time has changed to: " + newTime + "</p></blockquote>\n . <p>See you there</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
